...
val stateSpaceIntro = <.div(
  ...
  marked("""
    ...
    |* Heuristics, and what we as humans tend to do when the game starts getting big
    |* The search strategies that computers use when the state starts getting bigger, and how computers use heuristics too
    |
